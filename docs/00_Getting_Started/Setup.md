...
## Required Installation: Node.js Ecosystem
This prepares the frontend UI and Playwright automation suite, which is all you need to run your first health script.
