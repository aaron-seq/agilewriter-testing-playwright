...
# Supported Raw QA Formats

## Supported Inputs
- **Evaluation_Data** (The direct raw export from Agile Writer)
- **QA** (Anil's manual format export)

## Ownership Model
- **Raw QA Workbook**
  - Generated by Agile Writer
  - Must NOT be edited
- **Reference Workbook**
  - Maintained by QA
  - May be updated
- **Accuracy Scorer**
  - Compares Raw QA against Reference

## Non-Goals
The scorer does not:
- remap columns
- auto-detect arbitrary spreadsheets
- repair malformed workbooks
- infer workbook schemas
